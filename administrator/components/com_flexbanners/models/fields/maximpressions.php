...
class JFormFieldMaxImpressions extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		<label for="'.$this->id.'_unlimited" id="jform-maximpressions" type="text">'.JText::_('ADMIN_FLEXBANNER_UNLIMITED').'</label></fieldset>';
	}
}
