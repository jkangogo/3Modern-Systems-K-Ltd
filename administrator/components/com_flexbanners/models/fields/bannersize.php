...
class JFormFieldBannerSize extends JFormFieldList
{
	/**
	 * The form field type.
	 *
...
//		array_unshift($options, JHtml::_('select.option', '0', JText::_('ADMIN_FLEXBANNER_NEWSIZE')));
