			...
			<thead>
				<tr>
					...
					<th class="title nowrap" style="text-align:left">
						<?php echo JHtml::_('searchtools.sort', 'ADMIN_FLEXBANNER_CLIENT', 'a.clientname', $listDirn, $listOrder); ?>
					</th>
					<th width="30%" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'ADMIN_FLEXBANNER_CONTACTNAME', 'a.contactname', $listDirn, $listOrder); ?>
					</th>
					<th width="30%" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'ADMIN_FLEXBANNER_CONTACTEMAIL', 'a.contactemail', $listDirn, $listOrder); ?>
					</th>
